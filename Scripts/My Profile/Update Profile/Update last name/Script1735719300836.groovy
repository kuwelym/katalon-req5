...
WebElement firstnameField = driver.findElement(By.xpath("//input[@data-test='last-name']"))
firstnameField.clear()
firstnameField.sendKeys("LyMinh")
...
def query = "SELECT last_name FROM users WHERE email = 'lequochan@gmail.com'"
...
String lastName = driver.findElement(By.id("first_name")).getAttribute("value")
String dbLastName = result.getString("first_name")
